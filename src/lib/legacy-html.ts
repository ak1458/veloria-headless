...
const replacements: Array<[string, string]> = [
  ...
  [`${LEGACY_SITE_URL}/staging/contact-us/`, "/contact/"],
  [`${LEGACY_SITE_URL}/contact-us/`, "/contact/"],
  ...
  [`${LEGACY_SITE_URL}/staging/refund_returns/`, "/refund-returns/"],
  [`${LEGACY_SITE_URL}/refund_returns/`, "/refund-returns/"],
  [
    `${LEGACY_SITE_URL}/staging/cancellation-refund-policy/`,
    "/cancellation-refund/",
  ],
  [`${LEGACY_SITE_URL}/cancellation-refund-policy/`, "/cancellation-refund/"],
